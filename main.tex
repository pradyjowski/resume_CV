...
\section{EXPERIENCE}
 \vspace{-8pt}
   ...
   \end{tabbing}
   \vspace{-22pt}      % suppress blank line after tabbing
  ...
  \vspace{-18pt}
   \begin{tabbing}
   \hspace{2.3in}\= \hspace{2.7in}\= \kill % set up two tab positions
    {\bf Summer Intern} \> \parbox[c]{7.5cm}{ \centering Mitsubishi Electric Research Laboratories}    \> \parbox[c]{3.8cm}{ \raggedleft 05/2017 - 08/2018} \\
   \end{tabbing}
   \vspace{-22pt}      % suppress blank line after tabbing
    \begin{itemize}
   	\setlength{\leftmargin}{-15pt} \setlength\itemsep{0pt}
